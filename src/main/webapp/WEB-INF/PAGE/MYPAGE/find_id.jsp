...
<body>
	...
	<div id="container">
		...
		<div id="content">
 			<h3 class="newaccount">
                        <label for="newaccount">아이디 찾기</label>
                    </h3>
				<form:form action="${root }MYPAGE/find_id_pro" method="Get" modelAttribute="findUserBean">
				<div>
					<h3 class="join_title">
				...
				<div class="btn_area">
					<form:button id="btnJoin">아이디 찾기</form:button>
				</div>
			</form:form>
