   ...
   <nav>
      ...
      <div class="nav-links">
         <div class="nav-a">
            ...
            <a href="${root}MYPAGE/Wishlist">장바구니</a> 
            <a href="${root}MYPAGE/Orderlist">대여내역</a> 
            <a href="${root}MYPAGE/Deliverlist">배송조회</a> 
            <a href='${root}POINT/ChargePoint'>포인트충전</a> 
            <a href='${root}POINT/CharityPage'>기부</a> 
            <a href='${root}POINT/PointInfo'>포인트내역</a>
            <a href='${root}MYPAGE/Mypage_QnA'>나의문의</a>
            <div>&nbsp;</div>
         </div>
         <div class="nav-a">
            <a href='${root}NBQA/notice'>공지사항</a> 
            <a href='${root}NBQA/board'>게시판</a> 
            <a href='${root}NBQA/q_a'>문의</a> 
